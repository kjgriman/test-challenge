// Datos del juego para terapia del habla
...
export const gameUtils = {
  ...
  getWordsByCategory(category: GameWord['category']): GameWord[] {
    return gameWords.filter(word => word.category === category);
  },

  // Obtener palabras por dificultad
  getWordsByDifficulty(difficulty: GameWord['difficulty']): GameWord[] {
    return gameWords.filter(word => word.difficulty === difficulty);
  },
